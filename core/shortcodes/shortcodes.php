...
function core_shortcode_notify($atts, $content=null, $tag) {
	...
	if ($bg !='' && $color  !='')
		return '<div class="shortcode-notify ' .$type. '" style="background-color: '.$bg.'; color: '.$color.'; ">' .do_shortcode($content). '</div>';
		
	if ($bg !='')
		return '<div class="shortcode-notify ' .$type. '" style="background-color: '.$bg.'; ">' .do_shortcode($content). '</div>';
		
	if ($color !='')
		return '<div class="shortcode-notify ' .$type. '" style="color: '.$color.'; ">' .do_shortcode($content). '</div>';
