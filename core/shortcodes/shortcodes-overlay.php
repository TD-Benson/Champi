...
$shortcode_categories = array(
	...
	__('Notifications', THEME_SLUG) => array(
		...
		__('Custom', THEME_SLUG) => array(
			'description' => __('A notification box with custom background and text color.', THEME_SLUG),
			'shortcode' => '[notify textbox-white bg="#000000" color="#FFFFFF"]Text here[/notify]',
		),
	),
