...
function mejs_create_menu() {
	...
	// changed to add_theme_page() function
	//add_options_page('MediaElement.js', 'MediaElement.js', 'administrator', __FILE__, 'mejs_settings_page');
	//add_theme_page('MediaElement.js', 'MediaElement.js', 'administrator', __FILE__, 'mejs_settings_page');
	//add_submenu_page('options-general.php', 'MediaElement.js', 'MediaElement.js', 'administrator', __FILE__, 'mejs_settings_page');
...
<?php wp_nonce_field('update-options'); ?>
	...
	<p>
		<?php // text domain added ?>
		<input type="submit" class="button-primary" value="<?php _e('Save Changes', THEME_SLUG) ?>" />
	</p>
...
define('MEDIAELEMENTJS_DIR', THEME_URI .'/core/audio/mediaelement/');
// Javascript 
