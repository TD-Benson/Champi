...
function core_sociables($class='theme-sociables', $custom_entries = array() ) {
	...
	foreach ($core_sociables as $slug => $sociable) {
		...
		if ($icon)
			echo '<div class="sociable-item"><a href="', $link, '"><img class="icon" src="', $icon, '"><img class="icon-hover" src="', $icon_hover, '"></a></div>';
		else
			echo '<div class="sociable-item"><a href="', $link, '">', $sociable['title'], '</a></div>';
	}
