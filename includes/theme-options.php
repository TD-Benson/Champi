...
function theme_options_register() {
	...
	$option->parameters = array('custom' => 'custom', 'white' => 'white', 'black' => 'black', 'blue' => 'blue', 'grey' => 'grey');
	$section->option_add($option);	
	
	$option = new CoreOption('layout_style', __('Page Layout Style', THEME_SLUG), 'select', __('This setting toggles the 100% fullwidth, 100% fluid or boxed layout style of your site.', THEME_SLUG), 'fullwidth');
	...
	$section->option_add(new CoreOption('logo_small', __('Menu logo', THEME_SLUG), 'image', __('The logo displayed on the navigation when the page is being scrolled.', THEME_SLUG), null));
	...
	$options_colors->section_add($section);
	$section->option_add(new CoreOption('color_sidebar_bg', __('Blog and Sidebar content background', THEME_SLUG), 'color', null, '#211e21'));
