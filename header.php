...
add_action('wp_head', 'load_page_styles');
?>
<!--[if IE 7]>
...
<div id="top-slidepanel" class="container" >
    ...
    <div class="slidepanel-arrow"></div>
</div>
<?php endif;?>
...
<div class="container">	
	...
	<div id="theme-header">
		...
		<div class="row">
			<div id="theme-logo" style="text-align: <?php if(in_array(core_options_get('logo_align'), array('left', 'center', 'right'))) { echo core_options_get('logo_align'); } ?>;">
	...
	<!-- Main menu -->
	<div id="theme-navigation-row" class="">
		<div class="row">
			<div id="theme-navigation" class="twelvecol last">
				<?php if(core_options_get('logo_small') != '' ) : ?>
					<div id="theme-logo-menu"><a href="<?php echo home_url(); ?>"><img src="<?php echo core_options_get('logo_small'); ?>" alt="<?php echo bloginfo('name'); ?>"></a>
</div>			
				<?php endif; ?>
				<?php 
					// Main menu
